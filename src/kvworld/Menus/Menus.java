        ...
        if (turno = true) {
            ...
            try {
                ...
                if (n > 0 || n >= J2.getATropas().size()) {
                    J2.getAsend().add(J2.getATropas().get(n));
                }
            } catch (IndexOutOfBoundsException e) {
            }
        }
                ...
                if (n < 0 || n > J1.getAsend().size()) {
                    ...
                    switch (AET) {
                        case 1:
                            ...
                            int vida = J2.getAEdificios().get(EAtack).getVida();
                            int atack = J1.getAsend().get(n).getAtaque();
                            J2.getAEdificios().get(EAtack).setVida(vida - atack);
                        ...
                        case 2:
                            ...
                            int vida2 = J2.getATropas().get(TAtack).getVida();
                            int atack2 = J1.getAsend().get(n).getAtaque();
                            J2.getATropas().get(TAtack).setVida(vida2 - atack2);
